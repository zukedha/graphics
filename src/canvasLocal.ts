...
export class CanvasLocal {
  ...
  paint() {
    ...
    let xA, yA, xB, yB, xC, yC,xD, yD, xE , yE, xF , yF, xG , yG, xH , yH,
    xA1, yA1, xB1, yB1, xC1, yC1, xD1, yD1, xE1 , yE1, xF1 , yF1, xG1 , yG1, xH1 , yH1, p, q;
     q = 0.05;
    p = 1 - q;
    /*xA = xCenter - sideHalf;
    yA = yCenter - 0.5 * h;
    ...
    for (let m = 0; m < 4; m++){
      for (let n = 0; n < 4; n++){
        ...
        for (let i = 0; i < 50; i++){
          ...
          xF1 = p * xF + q * xA;
          yF1 = p * yF + q * yA;
          xA = xA1; xB = xB1; xC = xC1; xD = xD1; xE = xE1;xF = xF1;
          yA = yA1; yB = yB1; yC = yC1; yD = yD1; yE = yE1; yF = yF1;
        }
      }
    }
